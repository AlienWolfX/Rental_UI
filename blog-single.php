    ...
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a class="active" href="blog.php">Car-Details</a></li>
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-6">
            ...
            <p>Our newsletter delivers timely updates, exclusive content,
               and valuable insights to keep you informed and engaged in the latest happenings and trends.</p>
          </div>
          <div class="col-lg-6">
